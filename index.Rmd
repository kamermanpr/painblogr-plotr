...
The app was developed by Peter Kamerman (WWW: [painblogr.org](https://www.painblogr.org){ target='_blank'}, GitHub: [kamermanpr](https://github.com/kamermanpr){ target='_blank' }) and Kavalin Nair (GitHub: [TripleBlackCat](https://github.com/TripleBlackCat){ target='_blank' }).
